...
describe EffortsController do
  ...
  # EffortsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested effort as @effort" do
      effort = Effort.create! valid_attributes
      get :show, {:id => effort.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested effort as @effort" do
      effort = Effort.create! valid_attributes
      get :edit, {:id => effort.to_param}, valid_session
      assigns(:effort).should eq(effort)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Effort" do
        expect {
          post :create, {:effort => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved effort as @effort" do
        ...
        post :create, {:effort => { "user_id" => "invalid value" }}, valid_session
        assigns(:effort).should be_a_new(Effort)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested effort" do
        ...
        Effort.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => effort.to_param, :effort => { "user_id" => "1" }}, valid_session
      end

      it "assigns the requested effort as @effort" do
        effort = Effort.create! valid_attributes
        put :update, {:id => effort.to_param, :effort => valid_attributes}, valid_session
        assigns(:effort).should eq(effort)
      end
    ...
    describe "with invalid params" do
      it "assigns the effort as @effort" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Effort.any_instance.stub(:save).and_return(false)
        put :update, {:id => effort.to_param, :effort => { "user_id" => "invalid value" }}, valid_session
        assigns(:effort).should eq(effort)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested effort" do
      effort = Effort.create! valid_attributes
      expect {
        delete :destroy, {:id => effort.to_param}, valid_session
      }.to change(Effort, :count).by(-1)
    end
